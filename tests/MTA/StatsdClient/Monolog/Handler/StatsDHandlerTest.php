...
namespace MTA\StatsdClient\Tests\Monolog\Handler;
...
class StatsDHandlerTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        if (!interface_exists('MTA\StatsdClient\StatsdClientInterface')) {
    ...
    {
        $client = $this->getMock('MTA\StatsdClient\StatsdClientInterface');
        $factory = $this->getMock('MTA\StatsdClient\Factory\StatsdDataFactoryInterface');
